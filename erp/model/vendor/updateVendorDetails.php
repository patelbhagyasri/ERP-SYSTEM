	...
	if(isset($_POST['vendorDetailsVendorID'])) {
		...
		if(!empty($vendorDetailsVendorID)){
			...
			if(!empty($vendorDetailsVendorFullName) && !empty($vendorDetailsVendorMobile) && !empty($vendorDetailsVendorAddress)) {
				...
				$vendorIDSelectStatement->execute(array('vendorID' => $vendorDetailsVendorID));
				...
				if($vendorIDSelectStatement->rowCount() > 0) {
					...
					$purchaseVendorNameStatement->execute(array('vendorName' => $vendorDetailsVendorFullName, 'vendorID' => $vendorDetailsVendorID));
					...
					$updateVendorInPurchaseTableStatement->execute(array('vendorName' => $vendorDetailsVendorFullName, 'vendorID' => $vendorDetailsVendorID));
