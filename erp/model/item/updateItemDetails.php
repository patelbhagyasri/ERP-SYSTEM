<?php
	...
	if(isset($_POST['itemNumber'])) {
		...
		if(!empty($itemNumber) && !empty($itemName) && isset($itemDetailsQuantity) && isset($itemDetailsUnitPrice)){
			...
			$stockSelectStatement->execute(array('itemNumber' => $itemNumber));
			...
			$updateItemDetailsStatement->execute(array('itemName' => $itemName, 'discount' => $discount, 'stock' => $newStock, 'unitPrice' => $itemDetailsUnitPrice, 'status' => $status, 'description' => $description, 'itemNumber' => $itemNumber));
			...
			$updateItemInSaleTableSstatement->execute(array('itemName' => $itemName, 'itemNumber' => $itemNumber));
			...
			$updateItemInPurchaseTableSstatement->execute(array('itemName' => $itemName, 'itemNumber' => $itemNumber));
