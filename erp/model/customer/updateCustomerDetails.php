<?php
	...
	if(isset($_POST['customerDetailsCustomerID'])) {
		...
		if(isset($customerDetailsCustomerFullName) && isset($customerDetailsCustomerMobile) && isset($customerDetailsCustomerAddress)) {
			...
			$customerIDSelectStatement->execute(array('customerDetailsCustomerID' => $customerDetailsCustomerID));
			...
			if($customerIDSelectStatement->rowCount() > 0) {
				...
				$updateCustomerInSaleTableStatement->execute(array('customerName' => $customerDetailsCustomerFullName, 'customerID' => $customerDetailsCustomerID));
